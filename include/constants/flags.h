...
#define FLAG_ROUTE11_PHOTOSHOOT         0x272 
...
#define FLAG_MERCYTOWN_SKULLFOSSIL      0x496
#define FLAG_MERCYTOWN_MAWILITE         0x497 
#define FLAG_BDI_ARMOR_FOSSIL           0x498 
...
#define FLAG_RECEIVED_TM_BRICK_BREAK         0x79 // Victory Road
