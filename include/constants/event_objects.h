...
#define OBJ_EVENT_PAL_TAG_GOBLIN              0x112A
#define OBJ_EVENT_PAL_TAG_STEFF               0x112B
#define OBJ_EVENT_PAL_TAG_BRENAE              0x112C
#define OBJ_EVENT_PAL_TAG_NORA                0x112D
#define OBJ_EVENT_PAL_TAG_AIDEN               0x112E
#define OBJ_EVENT_PAL_TAG_NINA                0x112F
#define OBJ_EVENT_PAL_TAG_NESS                0x1130
#define OBJ_EVENT_PAL_TAG_YAP                 0x1131
#define OBJ_EVENT_PAL_TAG_RACHEL              0x1132
#define OBJ_EVENT_PAL_TAG_GRACE               0x1133
#define OBJ_EVENT_PAL_TAG_JAY                 0x1134
#define OBJ_EVENT_PAL_TAG_GEORGE              0x1135
#define OBJ_EVENT_PAL_TAG_HOZIER              0x1136
#define OBJ_EVENT_PAL_TAG_WREN                0x1137
#define OBJ_EVENT_PAL_TAG_FLORENCE            0x1138
#define OBJ_EVENT_PAL_TAG_JULIE               0x1139
#define OBJ_EVENT_PAL_TAG_STVINCENT           0x114A
#define OBJ_EVENT_PAL_TAG_PIPLUP              0x114B
#define OBJ_EVENT_PAL_TAG_KATIE               0x114C
#define OBJ_EVENT_PAL_TAG_ROCKRUFF            0x114D
#define OBJ_EVENT_PAL_TAG_CHAPPELL            0x114E
#define OBJ_EVENT_PAL_TAG_IMPIDIMP            0x114F
