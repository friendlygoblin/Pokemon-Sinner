...
static const u16 sRegionMap_SpecialPlaceLocations[][2] =
{
    ...
    {MAPSEC_ABANDONED_SHIP,             MAPSEC_PETALBURG_CITY},
...
{
    [MAPSEC_LITTLEROOT_TOWN] = {MAP_GROUP(START_TOWN), MAP_NUM(START_TOWN), HEAL_LOCATION_START_TOWN},
    [MAPSEC_OLDALE_TOWN] = {MAP_GROUP(ECSTASY_TOWN), MAP_NUM(ECSTASY_TOWN), HEAL_LOCATION_ECSTASY_TOWN},
    [MAPSEC_DEWFORD_TOWN] = {MAP_GROUP(FURGE_TOWN), MAP_NUM(FURGE_TOWN), HEAL_LOCATION_FURGE_TOWN},
    [MAPSEC_LAVARIDGE_TOWN] = {MAP_GROUP(GODZILLAND), MAP_NUM(GODZILLAND), HEAL_LOCATION_GODZILLAND},
    [MAPSEC_FALLARBOR_TOWN] = {MAP_GROUP(SECOND_BEST_ISLAND), MAP_NUM(SECOND_BEST_ISLAND), HEAL_LOCATION_SECOND_BEST_ISLAND},
    [MAPSEC_VERDANTURF_TOWN] = {MAP_GROUP(BIG_DOG_ISLAND), MAP_NUM(BIG_DOG_ISLAND), HEAL_LOCATION_BIG_DOG_ISLAND},
    [MAPSEC_PACIFIDLOG_TOWN] = {MAP_GROUP(SAILOR_TOWN), MAP_NUM(SAILOR_TOWN), HEAL_LOCATION_SAILOR_TOWN},
    [MAPSEC_PETALBURG_CITY] = {MAP_GROUP(CRYSTAL_STREAM_CITY), MAP_NUM(CRYSTAL_STREAM_CITY), HEAL_LOCATION_CRYSTAL_STREAM_CITY},
    [MAPSEC_SLATEPORT_CITY] = {MAP_GROUP(BEAUTIFUL_PORT), MAP_NUM(BEAUTIFUL_PORT), HEAL_LOCATION_BEAUTIFUL_PORT},
    [MAPSEC_MAUVILLE_CITY] = {MAP_GROUP(MERCY_TOWN), MAP_NUM(MERCY_TOWN), HEAL_LOCATION_MERCY_TOWN},
    [MAPSEC_RUSTBORO_CITY] = {MAP_GROUP(CANDLEWAX_CITY), MAP_NUM(CANDLEWAX_CITY), HEAL_LOCATION_CANDLEWAX_CITY},
    [MAPSEC_FORTREE_CITY] = {MAP_GROUP(PORTRAIT_TOWN), MAP_NUM(PORTRAIT_TOWN), HEAL_LOCATION_PORTRAIT_TOWN},
    [MAPSEC_LILYCOVE_CITY] = {MAP_GROUP(NIGHTINGALE_CITY), MAP_NUM(NIGHTINGALE_CITY), HEAL_LOCATION_NIGHTINGALE_CITY},
    [MAPSEC_MOSSDEEP_CITY] = {MAP_GROUP(MIRROR_LAKE), MAP_NUM(MIRROR_LAKE), HEAL_LOCATION_MIRROR_LAKE},
    [MAPSEC_EVER_GRANDE_CITY] = {MAP_GROUP(MIRROR_CITY), MAP_NUM(MIRROR_CITY), HEAL_LOCATION_MIRROR_CITY},
    ...
    [MAPSEC_ROUTE_10] = {MAP_GROUP(ROUTE10), MAP_NUM(ROUTE10), HEAL_LOCATION_NONE},
