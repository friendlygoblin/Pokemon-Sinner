 ...
 * Task_NewGameBirchSpeech_StartBirchCyndaquilPlatformFade
 * Task_NewGameBirchSpeech_StartBirchCyndaquilPlatformFade
 ...
 * Task_NewGameBirchSpeech_ReshowBirchCyndaquil
 ...
 *  - Advances to Task_NewGameBirchSpeechSub_WaitForCyndaquil
 * Task_NewGameBirchSpeechSub_WaitForCyndaquil
...
static void Task_NewGameBirchSpeechSub_WaitForCyndaquil(u8);
static void Task_NewGameBirchSpeech_StartBirchCyndaquilPlatformFade(u8);
...
static void Task_NewGameBirchSpeech_ReshowBirchCyndaquil(u8);
...
static const u8 *const sMalePresetNames[] = {
    ...
    gText_DefaultNameHarley,
    gText_DefaultNameHazel,
    gText_DefaultNameJude,
    gText_DefaultNameMel,
...
#define tCyndaquilSpriteId data[9]
...
{
    u8 spriteId = gTasks[sBirchSpeechMainTaskId].tCyndaquilSpriteId;
    ...
    gTasks[taskId].func = Task_NewGameBirchSpeechSub_WaitForCyndaquil;
    gTasks[sBirchSpeechMainTaskId].tTimer = 0;
}

static void Task_NewGameBirchSpeechSub_WaitForCyndaquil(u8 taskId)
{
    s16 *data = gTasks[taskId].data;
    struct Sprite *sprite = &gSprites[gTasks[sBirchSpeechMainTaskId].tCyndaquilSpriteId];
...
static void Task_NewGameBirchSpeech_AndYouAre(u8 taskId)
{
    if (!RunTextPrintersAndIsPrinter0Active())
    {
        ...
        AddTextPrinterForMessage(TRUE);
        gTasks[taskId].func = Task_NewGameBirchSpeech_StartBirchCyndaquilPlatformFade;
    }
}

static void Task_NewGameBirchSpeech_StartBirchCyndaquilPlatformFade(u8 taskId)
{
    if (!RunTextPrintersAndIsPrinter0Active())
    {
        gSprites[gTasks[taskId].tBirchSpriteId].oam.objMode = ST_OAM_OBJ_BLEND;
        gSprites[gTasks[taskId].tCyndaquilSpriteId].oam.objMode = ST_OAM_OBJ_BLEND;
...
static void Task_NewGameBirchSpeech_StartPlayerFadeIn(u8 taskId)
{
    if (gTasks[taskId].tIsDoneFadingSprites)
    {
        ...
        gSprites[gTasks[taskId].tCyndaquilSpriteId].invisible = TRUE;
        if (gTasks[taskId].tTimer)
        {
            gTasks[taskId].tTimer--;
        }
...
static void Task_NewGameBirchSpeech_StartNamingScreen(u8 taskId)
{
    ...
    {
        FreeAllWindowBuffers();
        FreeAndDestroyMonPicSprite(gTasks[taskId].tCyndaquilSpriteId);
...
static void Task_NewGameBirchSpeech_SlidePlatformAway2(u8 taskId)
{
    ...
    {
        gTasks[taskId].func = Task_NewGameBirchSpeech_ReshowBirchCyndaquil;
    }
}

static void Task_NewGameBirchSpeech_ReshowBirchCyndaquil(u8 taskId)
{
    u8 spriteId;
    ...
    if (gTasks[taskId].tIsDoneFadingSprites)
    {
        ...
        gSprites[spriteId].invisible = FALSE;
        gSprites[spriteId].oam.objMode = ST_OAM_OBJ_BLEND;
        spriteId = gTasks[taskId].tCyndaquilSpriteId;
        gSprites[spriteId].x = 100;
        gSprites[spriteId].y = 75;
        gSprites[spriteId].invisible = FALSE;
        gSprites[spriteId].oam.objMode = ST_OAM_OBJ_BLEND;
...
static void Task_NewGameBirchSpeech_WaitForSpriteFadeInAndTextPrinter(u8 taskId)
{
    ...
    {
        gSprites[gTasks[taskId].tBirchSpriteId].oam.objMode = ST_OAM_OBJ_NORMAL;
        gSprites[gTasks[taskId].tCyndaquilSpriteId].oam.objMode = ST_OAM_OBJ_NORMAL;
        if (!RunTextPrintersAndIsPrinter0Active())
        {
            gSprites[gTasks[taskId].tBirchSpriteId].oam.objMode = ST_OAM_OBJ_BLEND;
            gSprites[gTasks[taskId].tCyndaquilSpriteId].oam.objMode = ST_OAM_OBJ_BLEND;
...
static u8 NewGameBirchSpeech_CreateCyndaquilSprite(u8 x, u8 y)
{
...
static void AddBirchSpeechObjects(u8 taskId)
{
    ...
    cyndaquilSpriteId = NewGameBirchSpeech_CreateCyndaquilSprite(100, 0x4B);
    gSprites[cyndaquilSpriteId].callback = SpriteCB_Null;
    gSprites[cyndaquilSpriteId].oam.priority = 0;
    gSprites[cyndaquilSpriteId].invisible = TRUE;
    gTasks[taskId].tCyndaquilSpriteId = cyndaquilSpriteId;
