...
{
    [REMATCH_ROSE] = REMATCH(TRAINER_ROSE_1, TRAINER_STEFF_2, TRAINER_WREN_3, TRAINER_ANN_2, TRAINER_ANN_3, ROUTE118),
    ...
    [REMATCH_LOLA] = REMATCH(TRAINER_LOLA_1, TRAINER_RACHEL_2, TRAINER_AMY_2, TRAINER_BRENAE, TRAINER_BRENAE_2, ROUTE109),
    [REMATCH_RICKY] = REMATCH(TRAINER_RICKY_1, TRAINER_WARIS, TRAINER_WARIS_2, TRAINER_MORPHEUS, TRAINER_RICKY_5, ROUTE109),
    ...
    [REMATCH_BROOKE] = REMATCH(TRAINER_BROOKE_1, TRAINER_YAPGOB, TRAINER_YAPGOB_2, TRAINER_BROOKE_4, TRAINER_BROOKE_5, ROUTE111),
    [REMATCH_WILTON] = REMATCH(TRAINER_WILTON_1, TRAINER_NORAH, TRAINER_NORAH_2, TRAINER_WILTON_4, TRAINER_WILTON_5, ROUTE111),
    [REMATCH_VALERIE] = REMATCH(TRAINER_VALERIE_1, TRAINER_TILLY, TRAINER_TILLY_2, TRAINER_BRENAE_3, TRAINER_VALERIE_5, MT_PYRE_6F),
    ...
    [REMATCH_JESSICA] = REMATCH(TRAINER_JESSICA_1, TRAINER_MEGGO, TRAINER_MEGGO_2, TRAINER_SPRAGGY_2, TRAINER_JESSICA_5, ROUTE121),
    [REMATCH_WINSTON] = REMATCH(TRAINER_WINSTON_1, TRAINER_MEINTH, TRAINER_MEINTH_2, TRAINER_AIDEN_2, TRAINER_WINSTON_5, ROUTE104),
    [REMATCH_STEVE] = REMATCH(TRAINER_STEVE_1, TRAINER_GEORGE_2, TRAINER_STEVE_3, TRAINER_STEVE_4, TRAINER_STEVE_5, ROUTE114),
    ...
    [REMATCH_DALTON] = REMATCH(TRAINER_DALTON_1, TRAINER_JULIE_2, TRAINER_DALTON_3, TRAINER_DALTON_4, TRAINER_DALTON_5, ROUTE118),
    [REMATCH_BERNIE] = REMATCH(TRAINER_BERNIE_1, TRAINER_JAY_2, TRAINER_GRACE_3, TRAINER_NINA_2, TRAINER_STEFF_3, ROUTE114),
    [REMATCH_ETHAN] = REMATCH(TRAINER_ETHAN_1, TRAINER_HARV_2, TRAINER_ETHAN_3, TRAINER_ETHAN_4, TRAINER_ETHAN_5, JAGGED_PASS),
    ...
    [REMATCH_KAREN] = REMATCH(TRAINER_PAULINE, TRAINER_KATIE_2, TRAINER_KATIE_3, TRAINER_KAREN_4, TRAINER_KAREN_5, ROUTE116),
    [REMATCH_JERRY] = REMATCH(TRAINER_JERRY_1, TRAINER_AUX, TRAINER_JERRY_3, TRAINER_JERRY_4, TRAINER_JERRY_5, ROUTE116),
    ...
    [REMATCH_MIGUEL] = REMATCH(TRAINER_MIGUEL_1, TRAINER_BEAR_2, TRAINER_AUX_2, TRAINER_MIGUEL_4, TRAINER_MIGUEL_5, ROUTE103),
    ...
    [REMATCH_CALVIN] = REMATCH(TRAINER_CALVIN_1, TRAINER_BEAR, TRAINER_AIDEN, TRAINER_Q, TRAINER_CAL, ROUTE102),
    [REMATCH_ELLIOT] = REMATCH(TRAINER_ELLIOT_1, TRAINER_Q_2, TRAINER_CHANTAL, TRAINER_CHANTAL_2, TRAINER_ELLIOT_5, ROUTE106),
    [REMATCH_ISAIAH] = REMATCH(TRAINER_ISAIAH_1, TRAINER_ISAIAH_2, TRAINER_ISAIAH_3, TRAINER_ISAIAH_4, TRAINER_ISAIAH_5, ROUTE128),
    [REMATCH_MARIA] = REMATCH(TRAINER_MARIA_1, TRAINER_GOSIA, TRAINER_GOSIA_2, TRAINER_NESS, TRAINER_MARIA_5, ROUTE117),
    ...
    [REMATCH_KATELYN] = REMATCH(TRAINER_KATELYN_1, TRAINER_TALIA_2, TRAINER_TALIA_3, TRAINER_KATELYN_4, TRAINER_KATELYN_5, ROUTE128),
    ...
    [REMATCH_SAWYER] = REMATCH(TRAINER_JAY, TRAINER_SAWYER_2, TRAINER_SAWYER_3, TRAINER_SAWYER_4, TRAINER_SAWYER_5, MT_CHIMNEY),
    ...
    [REMATCH_ROXANNE] = REMATCH(TRAINER_STVINCENT, TRAINER_STVINCENT_2, TRAINER_ROXANNE_3, TRAINER_ROXANNE_4, TRAINER_ROXANNE_5, RUSTBORO_CITY),
    [REMATCH_BRAWLY] = REMATCH(TRAINER_HOZIER, TRAINER_HOZIER_2, TRAINER_BRAWLY_3, TRAINER_BRAWLY_4, TRAINER_BRAWLY_5, DEWFORD_TOWN),
    [REMATCH_WATTSON] = REMATCH(TRAINER_BRIANMAY, TRAINER_BRIANMAY_2, TRAINER_WATTSON_3, TRAINER_WATTSON_4, TRAINER_WATTSON_5, MAUVILLE_CITY),
    [REMATCH_FLANNERY] = REMATCH(TRAINER_FLORENCE, TRAINER_FLORENCE_2, TRAINER_FLANNERY_3, TRAINER_FLANNERY_4, TRAINER_FLANNERY_5, LAVARIDGE_TOWN),
    [REMATCH_NORMAN] = REMATCH(TRAINER_MARINA, TRAINER_MARINA_2, TRAINER_NORMAN_3, TRAINER_NORMAN_4, TRAINER_NORMAN_5, PETALBURG_CITY),
    [REMATCH_WINONA] = REMATCH(TRAINER_CMAT, TRAINER_CMAT_2, TRAINER_WINONA_3, TRAINER_WINONA_4, TRAINER_WINONA_5, FORTREE_CITY),
    [REMATCH_TATE_AND_LIZA] = REMATCH(TRAINER_CHAPPELL, TRAINER_CHAPPELL_2, TRAINER_TATE_AND_LIZA_3, TRAINER_TATE_AND_LIZA_4, TRAINER_TATE_AND_LIZA_5, MOSSDEEP_CITY),
    [REMATCH_JUAN] = REMATCH(TRAINER_BOWIE, TRAINER_JUAN_2, TRAINER_JUAN_3, TRAINER_JUAN_4, TRAINER_JUAN_5, SOOTOPOLIS_CITY),
...
{
    CreateMaleMon(&gEnemyParty[0], SPECIES_PIDGEY, 5);
    LockPlayerFieldControls();
