...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_WILTON] = REMATCH(TRAINER_WILTON_1, TRAINER_NORAH, TRAINER_WILTON_3, TRAINER_WILTON_4, TRAINER_WILTON_5, ROUTE111),
    ...
    [REMATCH_CALVIN] = REMATCH(TRAINER_CALVIN_1, TRAINER_BEAR, TRAINER_AIDEN, TRAINER_Q, TRAINER_CALVIN_5, ROUTE102),
