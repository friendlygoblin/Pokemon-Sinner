...
{
    [REMATCH_ROSE] = REMATCH(TRAINER_ROSE_1, TRAINER_STEFF_2, TRAINER_WREN_3, TRAINER_ROSE_4, TRAINER_ROSE_5, ROUTE118),
    ...
    [REMATCH_KAREN] = REMATCH(TRAINER_PAULINE, TRAINER_KATIE_2, TRAINER_KAREN_3, TRAINER_KAREN_4, TRAINER_KAREN_5, ROUTE116),
