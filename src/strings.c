...
const u8 gText_DefaultNameHarley[] = _("Harley");
const u8 gText_DefaultNameHazel[] = _("Hazel");
const u8 gText_DefaultNameMel[] = _("Mel");
...
const u8 gText_WelcomeToHOF[] = _("Welcome to the DINNER GUEST LIST!");
...
const u8 gText_HOFNumber[] = _("GUEST LIST No. {STR_VAR_1}");
const u8 gText_LeagueChamp[] = _("SPECIAL DINNER GUEST!\nCONGRATULATIONS!");
...
const u8 gText_HallOfFame[] = _("DINNER GUEST LIST");
...
const u8 gText_CheckMapOfHoenn[] = _("Check the region map.");
...
const u8 gText_HallOfFameDebut[] = _("GUEST LIST DEBUT  ");
