...
const struct Tileset gTileset_gTileset_PokeCenter =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_gTileset_PokeCenter,
    .palettes = gTilesetPalettes_gTileset_PokeCenter,
    .metatiles = gMetatiles_gTileset_PokeCenter,
    .metatileAttributes = gMetatileAttributes_gTileset_PokeCenter,
    .callback = NULL,
};
...
const struct Tileset gTileset_prelude_town =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_prelude_town,
    .palettes = gTilesetPalettes_prelude_town,
    .metatiles = gMetatiles_prelude_town,
    .metatileAttributes = gMetatileAttributes_prelude_town,
    .callback = NULL,
};

const struct Tileset gTileset_gPreludeTown =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_gPreludeTown,
    .palettes = gTilesetPalettes_gPreludeTown,
    .metatiles = gMetatiles_gPreludeTown,
    .metatileAttributes = gMetatileAttributes_gPreludeTown,
    .callback = NULL,
};

const struct Tileset gTileset_PreludeTownTest =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_PreludeTownTest,
...
const struct Tileset gTileset_PreludeTown_Secondary =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_PreludeTown_Secondary,
    .palettes = gTilesetPalettes_PreludeTown_Secondary,
    .metatiles = gMetatiles_PreludeTown_Secondary,
    .metatileAttributes = gMetatileAttributes_PreludeTown_Secondary,
    .callback = NULL,
};

const struct Tileset gTileset_Caves_Primary =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_Caves_Primary,
    .palettes = gTilesetPalettes_Caves_Primary,
    .metatiles = gMetatiles_Caves_Primary,
    .metatileAttributes = gMetatileAttributes_Caves_Primary,
    .callback = NULL,
};

const struct Tileset gTileset_Caves_Secondary =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Caves_Secondary,
    .palettes = gTilesetPalettes_Caves_Secondary,
    .metatiles = gMetatiles_Caves_Secondary,
    .metatileAttributes = gMetatileAttributes_Caves_Secondary,
    .callback = NULL,
};
