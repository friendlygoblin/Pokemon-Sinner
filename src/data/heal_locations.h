static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_INTERLUDE_SHIP - 1] = {MAP_GROUP(SS_TIDAL_ROOMS), MAP_NUM(SS_TIDAL_ROOMS), 24, 14},
    [HEAL_LOCATION_GODZILLAND - 1] = {MAP_GROUP(GODZILLAND), MAP_NUM(GODZILLAND), 21, 17},
    ...
    [HEAL_LOCATION_MIRROR_CITY - 1] = {MAP_GROUP(MIRROR_CITY), MAP_NUM(MIRROR_CITY), 21, 20},
};
