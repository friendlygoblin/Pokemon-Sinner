...
static const struct SpriteFrameImage sPicTable_Jay[] = {
    overworld_ascending_frames(gObjectEventPic_Jay, 2, 4),
};

static const struct SpriteFrameImage sPicTable_Ann[] = {
    overworld_ascending_frames(gObjectEventPic_Ann, 2, 4),
};

static const struct SpriteFrameImage sPicTable_Wren[] = {
    overworld_ascending_frames(gObjectEventPic_Wren, 2, 4),
};

static const struct SpriteFrameImage sPicTable_Julie[] = {
    overworld_ascending_frames(gObjectEventPic_Julie, 2, 4),
};
...
static const struct SpriteFrameImage sPicTable_Spraggy[] = {
    overworld_ascending_frames(gObjectEventPic_Spraggy, 2, 4),
};

static const struct SpriteFrameImage sPicTable_PPElla[] = {
    overworld_ascending_frames(gObjectEventPic_PPElla, 2, 4),
};

static const struct SpriteFrameImage sPicTable_PPKatherine[] = {
    overworld_ascending_frames(gObjectEventPic_PPKatherine, 2, 4),
};

static const struct SpriteFrameImage sPicTable_HarvFrost[] = {
...
static const struct SpriteFrameImage sPicTable_Toto[] = {
    overworld_ascending_frames(gObjectEventPic_Toto, 2, 4),
};

static const struct SpriteFrameImage sPicTable_Meggo[] = {
    overworld_ascending_frames(gObjectEventPic_Meggo, 2, 4),
};

static const struct SpriteFrameImage sPicTable_Gosia[] = {
    overworld_ascending_frames(gObjectEventPic_Gosia, 2, 4),
};

static const struct SpriteFrameImage sPicTable_Cal[] = {
    overworld_ascending_frames(gObjectEventPic_Cal, 2, 4),
};

static const struct SpriteFrameImage sPicTable_Tilly[] = {
    overworld_ascending_frames(gObjectEventPic_Tilly, 2, 4),
};

static const struct SpriteFrameImage sPicTable_Waris[] = {
    overworld_ascending_frames(gObjectEventPic_Waris, 2, 4),
};

static const struct SpriteFrameImage sPicTable_Morpheus[] = {
    overworld_ascending_frames(gObjectEventPic_Morpheus, 2, 4),
};

static const struct SpriteFrameImage sPicTable_Q[] = {
    overworld_ascending_frames(gObjectEventPic_Q, 2, 4),
};

static const struct SpriteFrameImage sPicTable_Chantal[] = {
    overworld_ascending_frames(gObjectEventPic_Chantal, 2, 4),
};

static const struct SpriteFrameImage sPicTable_Nat[] = {
    overworld_ascending_frames(gObjectEventPic_Nat, 2, 4),
};
...
static const struct SpriteFrameImage sPicTable_AzurillOld[] = {
    overworld_ascending_frames(gObjectEventPic_AzurillOld, 2, 2),
};
