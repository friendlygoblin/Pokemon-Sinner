...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    TRAINER_CLASS(TEAM_AQUA, "RANDOM"),
    ...
    TRAINER_CLASS(PICNICKER, "ARTIST FAN", 4),
    ...
    TRAINER_CLASS(ELITE_FOUR, "TLDP MEMBER", 25, ITEM_ULTRA_BALL),
    TRAINER_CLASS(LEADER, "ARTIST", 25),
    ...
    TRAINER_CLASS(CHAMPION, "TLDP MEMBER", 50),
    ...
    TRAINER_CLASS(SALON_MAIDEN, "DIRECTOR CAL"),
    TRAINER_CLASS(DOME_ACE, "WARNING"),
    TRAINER_CLASS(PALACE_MAVEN, "PHOTOGRAPHER"),
    TRAINER_CLASS(ARENA_TYCOON, "FILM CREW"),
    TRAINER_CLASS(FACTORY_HEAD, "SCIENTIST", 5),
    TRAINER_CLASS(PIKE_QUEEN, "DIRECTOR"),
    TRAINER_CLASS(PYRAMID_KING, "BAND PICTURE"),
    TRAINER_CLASS(RS_PROTAG, "ARTIST DAVID"),
    TRAINER_CLASS(TLDP_FAN, "TLDP FAN", 10),
};
